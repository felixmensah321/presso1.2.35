...
//        $this->fillEndInfos();
     ...
     * @param Order $data
     */
    protected function updateOrderRecord($data)
    {
        $orderObj = $this->orderRepository->get($data->getEntityId());
        $orderObj->setExportedAt($this->curDate->date()->format('Y-m-d H:i:s'));
        $orderObj->save();
    }
