 ...
 */
class AddNespressoMemberIdAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute = $customerSetup->getEavConfig()
            ->getAttribute(Customer::ENTITY, Data::ATTRIBUTE_NESPRESSO_MEMBER_ID)
            ->addData(
                [
