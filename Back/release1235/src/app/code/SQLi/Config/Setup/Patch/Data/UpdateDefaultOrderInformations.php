...
class UpdateDefaultOrderInformations implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function apply()
    {
        $configurationList = [
            ...
            'general/region/state_required' => 'AU,BR,CA,HR,EE,IN,LV,LT,RO,ES,US'
        ];
