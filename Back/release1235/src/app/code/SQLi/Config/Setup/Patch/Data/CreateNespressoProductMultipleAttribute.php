...
/**
 * Class CreateNespressoProductMultipleAttribute.
 *
 * @package SQLi\Config\Setup\Patch\Data
 */
class CreateNespressoProductMultipleAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attributeSetId = $this->createAttributeSet('Nespresso', ProductAttributeInterface::ENTITY_TYPE_ID, 4);

        if ($attributeSetId) {
            $this->createAttributeGroup('Nespresso', ProductAttributeInterface::ENTITY_TYPE_ID, $attributeSetId, 10, $catalogSetup);
        }
        ...
        $this->productAttributeManagement->assign(
            $attributeSetId,
            $attribute->getAttributeGroup(\Magento\Catalog\Model\Product::ENTITY, $attributeSetId, 'Nespresso', 'attribute_group_id'),
            $attribute->getAttributeId(\Magento\Catalog\Model\Product::ENTITY, 'multiple_product'),
            10
        );
    }
