...
/**
 * Class AddNespressoMemberIdAttribute.
 *
 * @package SQLi\Customer\Setup\Patch\Data
 */
class AddCustomerRelationIdAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(
            Customer::ENTITY,
            Data::ATTRIBUTE_NESPRESSO_CUSTOMER_RELATION_ID,
            [
                'label' => 'Customer Relation ID',
                'type' => 'varchar',
                'input' => 'text',
                'position' => 180,
                'visible' => true,
        ...
        $attribute = $customerSetup->getEavConfig()
            ->getAttribute(Customer::ENTITY, Data::ATTRIBUTE_NESPRESSO_CUSTOMER_RELATION_ID)
            ->addData(
                [
