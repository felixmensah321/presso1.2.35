const messages = {
  en: {
    ...
    errorManagement: {
      ...
      accountExist: 'Email invalid or already existing',
      sessionError: {
  ...
  fr: {
    ...
    errorManagement: {
      genericTitle: 'An error has happened',
      genericMessage: 'Error message',
      accountExist: 'Cette adresse email est invalide ou existe déjà.',
      sessionError: {
  ...
  de: {
    ...
    errorManagement: {
      genericTitle: 'An error has happened',
      genericMessage: 'Error message',
      accountExist: 'E-Mail-Adresse ist ungültig oder besteht bereits',
      sessionError: {
  ...
  it: {
    ...
    errorManagement: {
      genericTitle: 'An error has happened',
      genericMessage: 'Error message',
      accountExist: 'E-mail non valida o già esistente',
      sessionError: {
